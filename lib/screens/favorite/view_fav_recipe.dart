...
class ViewFavRecipe extends StatefulWidget {
  const ViewFavRecipe({super.key, required this.recipe});
  final Map<String, dynamic> recipe;

  @override
  State<ViewFavRecipe> createState() => _ViewRecipeState();
}

class _ViewRecipeState extends State<ViewFavRecipe> {
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: Text(
                          recipe['favorite'] == 1
                              ...
                              : 'Do you want to add ${recipe['name']} to your favorites?',
                        ),
                        actions: [
                          TextButton(
